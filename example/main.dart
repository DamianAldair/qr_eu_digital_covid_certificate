...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      title: 'QR - EU Digital COVID Certificate',
      home: Scaffold(
        appBar: AppBar(
          title: const Text('QR - EU Digital COVID Certificate'),
          centerTitle: true,
        ),
        body: Center(
          child: ElevatedButton(
            ...
            onPressed: () {
              debugPrint(ParseCovidCertificate.toMap(exampleData).toString());
              final cert = ParseCovidCertificate.toObject(exampleData);
              debugPrint(cert.toMap().toString());
            },
          ),
        ),
      ),
